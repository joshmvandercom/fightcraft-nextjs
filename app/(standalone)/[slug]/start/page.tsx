...
function CTAButton({ onClick }: { onClick: () => void }) {
  return (
    ...
    >
      ...
      <span className="text-xs text-black/60 uppercase tracking-widest">50% off your first 3 months</span>
    </button>
  )
}
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      if (res.ok) {
        ...
        track('lead_created', { location: slug, lead_source: 'meta', offer: 'start-33' })
        metaPixelTrack('Lead')

        const checkoutRes = await fetch('/api/checkout', {
          method: 'POST',
          headers: { 'Content-Type': 'application/json' },
          body: JSON.stringify({ email, name, phone, location: slug, offer: 'start-33', cancelPath: `/${slug}/start` }),
        })
    ...
    <div className="flex flex-col bg-black min-h-screen">
      ...
      <div className="relative min-h-[85vh] flex items-center overflow-hidden">
        ...
        <div className="relative z-10 px-6 max-w-4xl mx-auto w-full text-center">
          <div className="flex justify-center mb-6">
            <img src="/images/fc-white-initials.svg" alt="FightCraft" className="h-12 brightness-0 invert" />
          </div>
          ...
          <h1 className="font-heading text-4xl md:text-6xl lg:text-7xl uppercase font-bold tracking-tight text-white mb-4 leading-[1.1]">
            {firstName
              ? <><span className="shimmer-once bg-[linear-gradient(90deg,#ef4444_0%,#f97316_40%,#fff_50%,#f97316_60%,#ef4444_100%)] bg-clip-text text-transparent">{firstName}</span>, ready to start training?</>
              : <>Start Training.<br />50% Off for 3 Months.</>
            }
          </h1>
          <p className="text-xl text-white/60 mb-8 max-w-2xl mx-auto">
            Every class. Every program. Unlimited access. Start today for just <span className="text-white font-bold">$33</span>.
          </p>
          ...
          <div className="flex justify-center mt-8">
            <div className="flex flex-col items-center gap-2">
              ...
              <p className="text-sm text-white/40">
                Rated <span className="text-white/60 font-bold">4.9</span> from <span className="text-white/60 font-bold">139+ reviews</span> on Google
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="relative py-20 px-6">
        ...
        <div className="relative z-10 max-w-4xl mx-auto">
          ...
          <p className="text-white/50 mb-14 max-w-xl">Pay $33 today and start training immediately. 50% off continues for 3 full months.</p>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              <span className="font-heading text-6xl font-bold text-white/30">1</span>
              <h3 className="font-heading text-xl uppercase font-bold tracking-tight text-white mb-3 -mt-2">Unlimited Classes</h3>
              <p className="text-white/60 text-sm leading-relaxed">
                Kickboxing, Muay Thai, BJJ, MMA, Wrestling. Every class on the schedule is yours. Train once a day or twice. No restrictions.
              </p>
            </div>

            <div>
              <span className="font-heading text-6xl font-bold text-white/30">2</span>
              <h3 className="font-heading text-xl uppercase font-bold tracking-tight text-white mb-3 -mt-2">World-Class Coaching</h3>
              <p className="text-white/60 text-sm leading-relaxed">
                Every class is led by experienced coaches who have trained competitive fighters and complete beginners. You&apos;ll never feel lost.
              </p>
            </div>

            <div>
              <span className="font-heading text-6xl font-bold text-white/30">3</span>
              <h3 className="font-heading text-xl uppercase font-bold tracking-tight text-white mb-3 -mt-2">All Levels Welcome</h3>
              <p className="text-white/60 text-sm leading-relaxed">
                Most of our members started as complete beginners. Our coaches meet you where you are and build you up from there.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="bg-white text-black py-20 px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-black/50 mb-12 max-w-xl">Simple. No hidden fees. No surprises.</p>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            <div className="border border-black/10 p-6">
              <p className="font-heading text-sm uppercase tracking-widest text-black/40 mb-2">Today</p>
              <p className="font-heading text-3xl font-bold mb-2">$33</p>
              <p className="text-sm text-black/60">Your first week. Full access to every class and program. Start immediately.</p>
            </div>
            <div className="border border-black/10 p-6">
              <p className="font-heading text-sm uppercase tracking-widest text-black/40 mb-2">Months 1-3</p>
              <p className="font-heading text-3xl font-bold mb-2">50% Off</p>
              <p className="text-sm text-black/60">Continue at half the normal weekly rate. Same unlimited access. No change in what you get.</p>
            </div>
            <div className="border border-black/10 p-6">
              <p className="font-heading text-sm uppercase tracking-widest text-black/40 mb-2">After 3 Months</p>
              <p className="font-heading text-3xl font-bold mb-2">Standard Rate</p>
              <p className="text-sm text-black/60">You continue at the regular weekly rate. By then, you won&apos;t want to stop.</p>
            </div>
          </div>

          <p className="text-xs text-black/40 text-center">12-month membership commitment. Cancel policy applies. See staff for details.</p>
        </div>
      </div>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-white/50 mb-8">Train one discipline or try them all. Your membership covers everything.</p>

              <div className="space-y-4">
                {['Kickboxing', 'Muay Thai', 'Brazilian Jiu-Jitsu', 'No-Gi Jiu-Jitsu', 'MMA', 'Wrestling', 'Kids Martial Arts'].map(prog => (
                  <div key={prog} className="flex gap-3 items-center">
                    ...
                    <span className="font-heading text-sm uppercase tracking-widest">{prog}</span>
                  </div>
                ))}
              </div>
            </div>
      ...
      <div className="relative py-20 px-6 overflow-hidden">
        <img src="/images/home/lian.jpeg" alt="FightCraft training" className="absolute inset-0 w-full h-full object-cover grayscale" />
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-white">
          ...
          <div className="space-y-4 text-lg text-white/70">
            <p>{firstName ? `Hey ${firstName}, I` : 'I'}&apos;ll be straight with you. Most people who think about trying martial arts never actually do it. They wait for the right time. The right price. The right mood.</p>
            <p>There is no right time. There&apos;s just the day you decide to start.</p>
            <p>$33 for your first week. Half price for 3 months. Every class, every program, every coach. That&apos;s about as low a barrier as we can build.</p>
            <p>The only thing left is you walking through the door.</p>
            <p className="text-white font-bold">{firstName ? `${firstName}, we'll` : "We'll"} be here when you do.</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-black text-white py-20 px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-8 mb-12">
            {[
              { q: 'What does 50% off for 3 months mean?', a: 'You pay half the normal weekly rate for your first 3 months of training. Start today for $33 (your first week), then continue at the discounted rate.' },
              { q: 'Do I need experience?', a: 'None. Most of our members started as complete beginners. Our coaches meet you where you are.' },
              { q: 'What classes can I take?', a: 'All of them. Kickboxing, Muay Thai, BJJ, MMA, Wrestling. Your membership covers every class on the schedule.' },
              { q: 'What do I need to bring?', a: 'Athletic clothes and water. We have loaner gear available while you get started.' },
              { q: 'Is there a commitment?', a: 'Yes, this is a 12-month membership at our discounted rate. After 3 months, you continue at the standard weekly rate.' },
              { q: 'What if I want to cancel?', a: 'Standard cancellation policy applies. See our team for details.' },
            ].map(item => (
              <div key={item.q}>
      ...
      <div className="relative py-20 px-6 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          <h2 className="font-heading text-3xl md:text-5xl uppercase font-bold tracking-tight text-white mb-4">
            {firstName ? `${firstName}, Your First Class Is Waiting.` : 'Your First Class Is Waiting.'}
          </h2>
          <p className="text-white/60 mb-2">50% off for 3 months. Start today for $33.</p>
          <p className="text-white/40 text-sm mb-8">12-month membership. Every class. Every program. Unlimited.</p>

          <CTAButton onClick={() => setModalOpen(true)} />

          <p className="text-white/20 text-xs mt-8">FightCraft {loc.name} &middot; {loc.address}, {loc.city}, {loc.state} {loc.zip}</p>
        </div>
      </div>
          ...
          <div className="relative w-full max-w-md">
            ...
            <div className="bg-white text-black rounded-xl shadow-2xl overflow-hidden">
              ...
              <div className="p-8">
                ...
                <p className="text-center text-sm text-black/40 mt-4">50% off for 3 months. 12-month membership.</p>
              </div>
            </div>
          </div>
        </div>
