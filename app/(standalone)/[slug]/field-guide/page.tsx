          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-8">
              {[
                ...
                { q: 'Should I do striking or grappling first?', a: 'Whichever one excites you. Kickboxing is high energy and a lot of members start there. BJJ is a completely different experience and the people who try it tend to become lifers. Try both and see which one pulls you back.' },
